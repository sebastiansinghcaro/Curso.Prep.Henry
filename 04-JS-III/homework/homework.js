...
function empiezaConNueve(n) {
  ...
  //parámetro un número entero n. Debe retornar true si el entero 
...
function breakStatement(numero) {
  ...
  //Devolver el array
  //Si en algún momento el valor de la suma y la
  //cantidad de iteraciones coinciden, debe interrumpirse la ejecución y  
